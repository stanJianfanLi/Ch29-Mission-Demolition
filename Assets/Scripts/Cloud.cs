...
public class Cloud : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < num; i++)
        {
            ...
            scale.x = Random.Range(sphereScaleRangeX.x, sphereScaleRangeX.x);
            scale.y = Random.Range(sphereScaleRangeY.x, sphereScaleRangeY.x);
            scale.z = Random.Range(sphereScaleRangeZ.x, sphereScaleRangeZ.x);
